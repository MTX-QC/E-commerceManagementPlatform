package com.mtx.cloud.mall.user.controller;
...
import com.mtx.cloud.mall.common.util.EmailUtil;
...
//校验邮箱是否有效那个类，很一般~~~
     ...
     * 更新个性签名JWT方式
     */
/*    @PostMapping("/user/updateJWT")
    @ResponseBody
    public ApiRestResponse updateUserInfoUpdateJWT(@RequestParam String signature)
            throws MtxMallException {
